DOMAIN ICO_Domain {
	...
	COMPONENT LeftTorso {FLEXIBLE left_torso_posture(trex_internal_dispatch_asap)} : RobotTorsoType;
	...
	SYNCHRONIZE LeftArmController.left_arm {
		...
		VALUE AssumeManipulationPose() {
			...
			cd1 LeftTorso.left_torso_posture.Posture(?torsoPosture);
		...
		VALUE AssumeDrivingPose() {
			...
			cd2 LeftTorso.left_torso_posture.Posture(?torsoPosture);
