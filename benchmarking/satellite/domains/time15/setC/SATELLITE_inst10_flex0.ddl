DOMAIN SATELLITE_Domain
{
	...
	COMPONENT Satellite_Instrument_10 {FLEXIBLE inst10(trex_internal_dispatch_asap)} : InstrumentType;
	...
	SYNCHRONIZE Satellite_Operation.op_trace
	{
		VALUE Science()
		{
			...
			cd11 <!> Satellite_Instrument_10.inst10.Process();
			cd12 <!> Satellite_Instrument_10.inst10.Idle();
			
			cd13 Satellite_Instrument_1.inst1.Idle();
			cd141 Satellite_Instrument_2.inst2.Idle();
			cd142 Satellite_Instrument_2.inst2.Idle();
			cd151 Satellite_Instrument_3.inst3.Idle();
			cd152 Satellite_Instrument_3.inst3.Idle();
			cd161 Satellite_Instrument_4.inst4.Idle();
			cd162 Satellite_Instrument_4.inst4.Idle();
			cd171 Satellite_Instrument_5.inst5.Idle();
			cd172 Satellite_Instrument_5.inst5.Idle();
			cd181 Satellite_Instrument_6.inst6.Idle();
			cd182 Satellite_Instrument_6.inst6.Idle();
			cd191 Satellite_Instrument_7.inst7.Idle();
			cd192 Satellite_Instrument_7.inst7.Idle();
			cd201 Satellite_Instrument_8.inst8.Idle();
			cd202 Satellite_Instrument_8.inst8.Idle();
			cd211 Satellite_Instrument_9.inst9.Idle();
			cd212 Satellite_Instrument_9.inst9.Idle();
			cd22 Satellite_Instrument_10.inst10.Idle();
			...
			cd0 DURING [0, +INF] [0, +INF] cd201;
			cd0 DURING [0, +INF] [0, +INF] cd211;
			cd0 DURING [0, +INF] [0, +INF] cd22;				

			cd3 DURING [0, +INF] [0, +INF] cd13;
			...
			cd3 DURING [0, +INF] [0, +INF] cd201;
			cd3 DURING [0, +INF] [0, +INF] cd211;
			cd3 DURING [0, +INF] [0, +INF] cd22;
			
			cd4 DURING [0, +INF] [0, +INF] cd13;
			cd4 DURING [0, +INF] [0, +INF] cd142;
			cd4 DURING [0, +INF] [0, +INF] cd161;
			cd4 DURING [0, +INF] [0, +INF] cd171;
			cd4 DURING [0, +INF] [0, +INF] cd181;
			cd4 DURING [0, +INF] [0, +INF] cd191;
			cd4 DURING [0, +INF] [0, +INF] cd201;
			cd4 DURING [0, +INF] [0, +INF] cd211;
			cd4 DURING [0, +INF] [0, +INF] cd22;
			
			cd5 DURING [0, +INF] [0, +INF] cd13;
			cd5 DURING [0, +INF] [0, +INF] cd142;
			cd5 DURING [0, +INF] [0, +INF] cd152;
			cd5 DURING [0, +INF] [0, +INF] cd171;
			cd5 DURING [0, +INF] [0, +INF] cd181;
			cd5 DURING [0, +INF] [0, +INF] cd191;
			cd5 DURING [0, +INF] [0, +INF] cd201;
			cd5 DURING [0, +INF] [0, +INF] cd211;
			cd5 DURING [0, +INF] [0, +INF] cd22;
			
			cd6 DURING [0, +INF] [0, +INF] cd13;
			cd6 DURING [0, +INF] [0, +INF] cd142;
			cd6 DURING [0, +INF] [0, +INF] cd152;
			cd6 DURING [0, +INF] [0, +INF] cd162;
			cd6 DURING [0, +INF] [0, +INF] cd181;
			cd6 DURING [0, +INF] [0, +INF] cd191;
			cd6 DURING [0, +INF] [0, +INF] cd201;
			cd6 DURING [0, +INF] [0, +INF] cd211;
			cd6 DURING [0, +INF] [0, +INF] cd22;
			
			cd7 DURING [0, +INF] [0, +INF] cd13;
			cd7 DURING [0, +INF] [0, +INF] cd142;
			cd7 DURING [0, +INF] [0, +INF] cd152;
			cd7 DURING [0, +INF] [0, +INF] cd162;
			cd7 DURING [0, +INF] [0, +INF] cd172;
			cd7 DURING [0, +INF] [0, +INF] cd191;
			cd7 DURING [0, +INF] [0, +INF] cd201;
			cd7 DURING [0, +INF] [0, +INF] cd211;
			cd7 DURING [0, +INF] [0, +INF] cd22;
			
			cd8 DURING [0, +INF] [0, +INF] cd13;
			cd8 DURING [0, +INF] [0, +INF] cd142;
			cd8 DURING [0, +INF] [0, +INF] cd152;
			cd8 DURING [0, +INF] [0, +INF] cd162;
			cd8 DURING [0, +INF] [0, +INF] cd172;
			cd8 DURING [0, +INF] [0, +INF] cd182;
			cd8 DURING [0, +INF] [0, +INF] cd201;
			cd8 DURING [0, +INF] [0, +INF] cd211;
			cd8 DURING [0, +INF] [0, +INF] cd22;
			
			cd9 DURING [0, +INF] [0, +INF] cd13;
			...
			cd9 DURING [0, +INF] [0, +INF] cd192;
			cd9 DURING [0, +INF] [0, +INF] cd211;
			cd9 DURING [0, +INF] [0, +INF] cd22;
			
			cd10 DURING [0, +INF] [0, +INF] cd13;
			...
			cd10 DURING [0, +INF] [0, +INF] cd202;
			cd10 DURING [0, +INF] [0, +INF] cd22;
			
			cd11 DURING [0, +INF] [0, +INF] cd13;
			cd11 DURING [0, +INF] [0, +INF] cd142;
			cd11 DURING [0, +INF] [0, +INF] cd152;
			cd11 DURING [0, +INF] [0, +INF] cd162;
			cd11 DURING [0, +INF] [0, +INF] cd172;
			cd11 DURING [0, +INF] [0, +INF] cd182;
			cd11 DURING [0, +INF] [0, +INF] cd192;
			cd11 DURING [0, +INF] [0, +INF] cd202;
			cd11 DURING [0, +INF] [0, +INF] cd212;
		}
	}
}