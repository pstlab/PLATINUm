DOMAIN SATELLITE_Domain
{
	...
	SYNCHRONIZE Satellite_Operation.op_trace
	{
		VALUE Science()
		{
			...
			cd82 Satellite_Instrument_2.inst2.Idle();
			cd91 Satellite_Instrument_3.inst3.Idle();
			cd92 Satellite_Instrument_3.inst3.Idle();
			cd10 Satellite_Instrument_4.inst4.Idle();
			...
			cd0 DURING [0, +INF] [0, +INF] cd81;
			cd0 DURING [0, +INF] [0, +INF] cd91;
			cd0 DURING [0, +INF] [0, +INF] cd10;
			
			cd3 DURING [0, +INF] [0, +INF] cd7;
			cd3 DURING [0, +INF] [0, +INF] cd91;
			cd3 DURING [0, +INF] [0, +INF] cd10;
			
			cd4 DURING [0, +INF] [0, +INF] cd7;
			cd4 DURING [0, +INF] [0, +INF] cd82;
			cd4 DURING [0, +INF] [0, +INF] cd10;
			
			cd5 DURING [0, +INF] [0, +INF] cd7;
			cd5 DURING [0, +INF] [0, +INF] cd82;
