DOMAIN GECKO_Domain
{
		...
		Channel_R3_F(), Channel_R3_B(), Channel_R3_L1(), Channel_R3_L2(), Channel_R3_L3(), Channel_R3_R1(), Channel_R3_R2())
	{
		...
		VALUE Channel_L2_R3() [1, +INF]
		MEETS {
			Idle();
		}
		
		VALUE Channel_L3_F() [1, +INF]
		MEETS {
			Idle();
		}
		
		VALUE Channel_L3_B() [1, +INF]
		MEETS {
			Idle();
		}
		
		VALUE Channel_L3_L1() [1, +INF]
		MEETS {
			Idle();
		}
		
		VALUE Channel_L3_L2() [1, +INF]
		MEETS {
			Idle();
		}
			
		VALUE Channel_L3_R1() [1, +INF]
		MEETS {
			Idle();
		}
		
		VALUE Channel_L3_R2() [1, +INF]
		MEETS {
			Idle();
		}
		
		VALUE Channel_L3_R3() [1, +INF]
		MEETS {
			Idle();
		}
		...
		VALUE Channel_R3_F() [1, +INF]
		MEETS {
			Idle();
		}
		 
		VALUE Channel_R3_B() [1, +INF]
		MEETS {
			Idle();
		}
		
		VALUE Channel_R3_L1() [1, +INF]
		MEETS {
			Idle();
		}
		
		VALUE Channel_R3_L2() [1, +INF]
		MEETS {
			Idle();
		}
		
		VALUE Channel_R3_L3() [1, +INF]
		MEETS {
			Idle();
		}
		
		VALUE Channel_R3_R1() [1, +INF]
		MEETS {
			Idle();
		}
		
		VALUE Channel_R3_R2() [1, +INF]
		MEETS {
			Idle();
		}
	...
	SYNCHRONIZE TM_Channel.channel
	{
		...
		{
			cd0 TM_ChangeOverTrace.change_over.CO_FB();
			cd1 <!> TM_ChangeOverTrace.change_over.CO_L3R3();
			cd2 <!> TM_EnergyTrace.energy.REQUIREMENT(?amount0 = 3);
			cd3 <?> TM_NeighborF.neighborF.Available();
			cd4 <?> TM_NeighborR.neighborR.Available();
		...
		{
			cd0 TM_ChangeOverTrace.change_over.CO_FB();
			cd1 <!> TM_ChangeOverTrace.change_over.CO_R3L3();
			cd2 <!> TM_EnergyTrace.energy.REQUIREMENT(?amount0 = 7);
			cd3 <?> TM_NeighborF.neighborF.Available();
			cd4 <?> TM_NeighborL.neighborL.Available();
		...
		{
			cd0 TM_ChangeOverTrace.change_over.CO_R1L1();
			cd4 <!> TM_ChangeOverTrace.change_over.CO_R3L3();	
			cd1 <!> TM_EnergyTrace.energy.REQUIREMENT(?amount0 = 5);
			cd2 <?> TM_NeighborR.neighborR.Available();
			cd3 <?> TM_NeighborL.neighborL.Available();
		...
		{
			cd0 TM_ChangeOverTrace.change_over.CO_R1L1();
			cd3 <!> TM_ChangeOverTrace.change_over.CO_L3R3();
			cd1 <!> TM_EnergyTrace.energy.REQUIREMENT(?amount0 = 5);
			cd2 <?> TM_NeighborR.neighborR.Available();
		...
		VALUE Channel_R3_L1()
		{
			cd0 TM_ChangeOverTrace.change_over.CO_R3L3();
			cd4 <!> TM_ChangeOverTrace.change_over.CO_R1L1();
			cd1 <!> TM_EnergyTrace.energy.REQUIREMENT(?amount0 = 5);
			cd2 <?> TM_NeighborR.neighborR.Available();
			cd3 <?> TM_NeighborL.neighborL.Available();
		...
		{
			cd0 TM_ChangeOverTrace.change_over.CO_L1R1();
			cd4 <!> TM_ChangeOverTrace.change_over.CO_L3R3();
			cd1 <!> TM_EnergyTrace.energy.REQUIREMENT(?amount0 = 5);
			cd2 <?> TM_NeighborR.neighborR.Available();
			cd3 <?> TM_NeighborL.neighborL.Available();
		...
		{
			cd0 TM_ChangeOverTrace.change_over.CO_R1L1();
			cd2 <!> TM_ChangeOverTrace.change_over.CO_R3L3();	
			cd1 <!> TM_EnergyTrace.energy.REQUIREMENT(?amount0 = 5);
			cd3 <?> TM_NeighborL.neighborL.Available();
		...
		VALUE Channel_L3_R1()
		{
			cd0 TM_ChangeOverTrace.change_over.CO_L3R3();
			cd4 <!> TM_ChangeOverTrace.change_over.CO_L1R1();	
			cd1 <!> TM_EnergyTrace.energy.REQUIREMENT(?amount0 = 5);
			cd2 <?> TM_NeighborR.neighborR.Available();
			cd3 <?> TM_NeighborL.neighborL.Available();
		...
		{
			cd0 TM_ChangeOverTrace.change_over.CO_L3R3();
			cd2 <!> TM_ChangeOverTrace.change_over.CO_L2R2();
			cd1 <!> TM_EnergyTrace.energy.REQUIREMENT(?amount0 = 5);
			cd3 <?> TM_NeighborL.neighborL.Available();
