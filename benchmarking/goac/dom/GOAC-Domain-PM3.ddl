DOMAIN GOAC_Domain {
	...
	COMP_TYPE SingletonStateVariable RobotBaseType (GoingTo(coordinate, coordinate), At(coordinate, coordinate), StuckAt(coordinate, coordinate) )
	{
	...
	{
		VALUE MovingTo(?pan1, ?tilt1)  [1, +INF]
		...
		VALUE PointingAt(?pan1, ?tilt1) [10, 20]
	...
	COMP_TYPE SingletonStateVariable CommunicationType (CommIdle(), Communicating(file_id))
	{
		...
		VALUE Communicating(?file_id) [10, 20]
