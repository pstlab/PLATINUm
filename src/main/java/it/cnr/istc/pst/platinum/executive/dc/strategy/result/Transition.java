...
public class Transition implements Action {
	...
	public Transition(String timeline, String from, String to) {
		this();
		this.transitionFrom = new State(timeline,from);
		this.transitionTo = new State(timeline,to);
	}
	...
	public String getTimeline() {
		return this.transitionTo.getTimeline();
	}
	@Override
