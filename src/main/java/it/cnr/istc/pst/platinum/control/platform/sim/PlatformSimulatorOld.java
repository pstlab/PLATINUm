...
import it.cnr.istc.pst.platinum.control.platform.PlatformCommandDescription;
 ...
 *
 */
public class PlatformSimulatorOld extends RunnablePlatformProxy implements PlatformAgentObserver 
{
	 ...
	 * 
	 */
	protected PlatformSimulatorOld() {
		super();
