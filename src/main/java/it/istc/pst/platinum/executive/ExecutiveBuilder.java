...
import it.istc.pst.platinum.executive.pdb.ExecutivePlanDataBaseBuilder;
...
public class ExecutiveBuilder 
{
	 ...
	 * @return
	 */
	public synchronized static Executive createAndSet()
	{
		// create executive
		return ExecutiveBuilder.createAndSet(Executive.class, EPSLExecutivePlanDataBase.class, 0, Long.MAX_VALUE - 1);
	}
