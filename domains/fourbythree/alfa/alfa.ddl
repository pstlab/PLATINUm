DOMAIN ALFA
{
		...
		Task_2_1(), Task_2_3a(), Task_2_3b(), Task_2_4a(), Task_2_4b(), Task_2_5(), Task_2_6())
	{
		...
		VALUE Task_1_3() [1, +INF]
		MEETS {
			Idle();
		} 
		
		VALUE Task_1_4() [1, +INF]
		MEETS {
			Idle();
		} 
		
		VALUE Task_1_6a() [1, +INF]
		MEETS {
			Idle();
		}
		
		VALUE Task_1_6b() [1, +INF]
		MEETS {
			Idle();
		}
	
		VALUE Task_1_7() [1, +INF]
		MEETS {
			Idle();
		}
	
		VALUE Task_2_1() [1, +INF]
		MEETS {
			Idle();
		}
		
		VALUE Task_2_3a() [1, +INF]
		MEETS {
			Idle();
		} 
		
		VALUE Task_2_3b() [1, +INF]
		MEETS {
			Idle();
		} 
		
		VALUE Task_2_4a() [1, +INF]
		MEETS {
			Idle();
		}
		 
		VALUE Task_2_4b() [1, +INF]
		MEETS {
			Idle();
		} 
		
		VALUE Task_2_5() [1, +INF]
		MEETS {
			Idle();
		} 
	
		VALUE Task_2_6() [1, +INF]
		MEETS {
			Idle();
		}
	}
	...
	COMPONENT FourByThree {FLEXIBLE case_study(functional)} : FourByThreeType;
	COMPONENT ALFA {FLEXIBLE process(functional) } : ALFAProcessType;
