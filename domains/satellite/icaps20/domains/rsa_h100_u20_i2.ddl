DOMAIN RSA_H100_U20_I2
{
	...
	COMP_TYPE SingletonStateVariable RSAInstrumentLock(None(), Inst1(), Inst2())
	{
		VALUE None() [1, +INF]
		MEETS {
			Inst1();
	...
	COMP_TYPE SingletonStateVariable VisibilityWindow (Visible(), NotVisible())
	{
		VALUE Visible() [1, +INF]
		MEETS {
			NotVisible();
	...
	COMPONENT GroundStation {FLEXIBLE visibility(external)} : VisibilityWindow;
	...
	SYNCHRONIZE RSA.operations 
	{
		...
		VALUE _Comm()
		{
			...
			cd1 <?> GroundStation.visibility.Visible();
