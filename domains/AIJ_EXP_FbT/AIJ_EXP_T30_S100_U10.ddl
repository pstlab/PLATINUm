DOMAIN AIJ_EXP_T30_S100_U10 {
	...
	COMP_TYPE SingletonStateVariable HumanSV (Idle(), _UnscrewTopBolt1(), _UnscrewTopBolt2(), _UnscrewTopBolt3(), _UnscrewTopBolt4(), _UnscrewTopBolt5(), _UnscrewTopBolt6(), _UnscrewTopBolt7(), _UnscrewTopBolt8(), _UnscrewTopBolt9(), _UnscrewTopBolt10(), _UnscrewTopBolt11(), _UnscrewTopBolt12(), _UnscrewTopBolt13(), _UnscrewTopBolt14(), _UnscrewTopBolt15(), _UnscrewBottomBolt1(), _UnscrewBottomBolt2(), _UnscrewBottomBolt3(), _UnscrewBottomBolt4(), _UnscrewBottomBolt5(), _UnscrewBottomBolt6(), _UnscrewBottomBolt7(), _UnscrewBottomBolt8(), _UnscrewBottomBolt9(), _UnscrewBottomBolt10(), _UnscrewBottomBolt11(), _UnscrewBottomBolt12(), _UnscrewBottomBolt13(), _UnscrewBottomBolt14(), _UnscrewBottomBolt15(), _SetWorkPiece(), _RemoveWaxPart()) {
		...
		VALUE _SetWorkPiece() [12, 32]
		MEETS {
			Idle();
		}

		VALUE _RemoveWaxPart() [21, 41]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt1() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt2() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt3() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt4() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt5() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt6() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt7() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt8() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt9() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt10() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt11() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt12() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt13() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt14() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewTopBolt15() [16, 36]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt1() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt2() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt3() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt4() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt5() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt6() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt7() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt8() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt9() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt10() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt11() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt12() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt13() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt14() [18, 38]
		MEETS {
			Idle();
		}

		VALUE _UnscrewBottomBolt15() [18, 38]
		MEETS {
			Idle();
		}
